                            ...
                            <table class="table table-hover table-striped datatable">
                                ...
                                @foreach($orders as $item)
                                    <tr>
                                        ...
                                        <td>
                                            @if($item->user)
                                                <a href="{{route('dashboard.contractorOrder.show', $item->user)}}">{{ $item->user->name}}</a>
                                            @endif
                                        </td>
                                        <td>
                                            @if($item->agent)
                                                <a href="{{route('dashboard.contractorOrder.show', $item->agent)}}">{{ $item->agent->name}}</a>
                                            @endif
                                        </td>
                                        <td>
                                            @if($item->city)
                                        ...
                                        <td>{{ $item->status}}</td>
                                        <td>
                                            <a href="{{route('dashboard.contractorOrder.show', $item)}}"
                                               class="btn btn-xs btn-success">عرض</a>
                                            <form action="{{route("dashboard.contractorOrder.destroy", $item)}}" method="post"
