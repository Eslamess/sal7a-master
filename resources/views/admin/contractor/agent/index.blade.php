                            ...
                            <table class="table table-hover table-striped datatable">
                                ...
                                @foreach($agents as $item)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{route('dashboard.contractorAgent.show', $item)}}"
                                               class="btn btn-xs btn-success">عرض</a>
{{--                                            <a href="{{route('dashboard.contractorAgent.edit', $item)}}"--}}
{{--                                               class="btn btn-xs btn-primary">تعديل</a>--}}
                                            <form action="{{route("dashboard.contractorAgent.destroy", $item->id)}}" method="post"
