    ...
    <div class="">
        <div class="page-title">
            <div class="title_left">
                ...
                <h3>{{isset($agent)?'تعديل الخدمة '.$agent->name: 'إضافة خدمة'}}</h3>
            </div>
        </div>
                ...
                <div class="x_panel">
                    <div class="x_content">
                        ...
                        <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left"
                              action="{{isset($agent)?route('dashboard.agent.update',$agent):route('dashboard.agent.store')}}"
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-9 col-sm-9 col-xs-12">
                                    <input type="password" required="required"
                                           ...
                                           value="@if(old('password')){{old('password')}}@elseif(isset($agent->password)){{$agent->password}}@endif">
                                </div>
                            </div>
